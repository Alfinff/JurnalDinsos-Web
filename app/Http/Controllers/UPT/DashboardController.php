...
class DashboardController extends Controller
{
    public function index(Request $request) {
        ...
        $jenisaduan = DB::select("SELECT j.nama, COUNT(*) AS jumlah FROM ms_pendaftaran p JOIN ms_jenis_aduan j ON j.uuid = p.jenis_aduan WHERE upt_id = '$upt_id' AND soft_delete = 0 GROUP BY jenis_aduan");
        ...
        return view('upt.dashboard', compact('countklien', 'countupt', 'lakilaki', 'perempuan', 'klienmasuk_tahunini', 'bulan_tahunini', 'pengeluaranupt', 'datajenisaduan'));
    }
}
