                ...
                <div class="card">
                    <div class="card-card">
                        ...
                        <div class="head-judul text-center mb-5">
                            <h3><i class="fa fa-news text-primary"></i> Tambah Berita</h3>
                        </div>
                        <hr>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="judul_berita" class="form-control" placeholder="Cth: Upacara Dinsos" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
