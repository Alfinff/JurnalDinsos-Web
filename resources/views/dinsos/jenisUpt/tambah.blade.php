					...
					<div class="card-card">
						...
						<div class="d-flex justify-content-center mb-3">
							<div class="d-flex head-juduls">
								<h5 style="margin: 0 0 0 5px"><i class="fa fa-plus-square-o text-primary"></i>  Tambah Jenis Upt</h5>
							</div>
						</div>
						<hr>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" required name="nama" id="nama" class="form-control" placeholder="Cth: Nama" value="{{old('nama')}}">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
