        ...
        <div class="card-card">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="head-juduls">
              <h5><i class="fa fa-users text-primary"></i> Data Pegawai</h5>
            </div>
            <a href="{{route('upt-tambah-pegawai')}}" class="btn btn-primary">Tambah</a>
          </div>
          <hr>
          <div style="overflow-y: auto">
            <table id="upt-DaftarPegawai" class="table table-striped table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
              <colgroup>
...
@section('jquery')
  <script>
    $(function() {
        $('#upt-DaftarPegawai').DataTable({
            processing: true,
            ajax: '{{URL::to('/upt/kepegawaian/pegawai/data')}}',
            columns:[
