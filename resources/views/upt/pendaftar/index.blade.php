                ...
                <tbody>
                    @foreach($pengaduan as $p)
                        <tr>
                            ...
                            <td>{{$p->tindakan}}</td>
                            {{-- <td>
                                <select name="" id="" class="form-select pilih_tindakan">
                                    @if($p->tindakan == null)
                                        <option value="{{$p->id}}-kosong" selected>Pilih Tindakan</option>
                                    @else
                                        <option value="{{$p->id}}-kosong">Pilih Tindakan</option>
                                    @endif
                                    @if($p->tindakan == "dihubungi")
                                        <option value="{{$p->id}}-dihubungi" selected>Dihubungi</option>
                                    @else
                                        <option value="{{$p->id}}-dihubungi">Dihubungi</option>
                                    @endif
                                    @if($p->tindakan == "ditangani")
                                        <option value="{{$p->id}}-ditangani" selected>Ditangani</option>
                                    @else
                                        <option value="{{$p->id}}-ditangani">Ditangani</option>
                                    @endif
                                </select>
                            </td> --}}
                            <td>
                                ...
                                @elseif($p->tindakan == "dihubungi")
                                    <a href="#" class="btn btn-primary">Tangani</a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
