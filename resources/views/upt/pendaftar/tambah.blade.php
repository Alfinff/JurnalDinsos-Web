                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_lengkap" id="nama" class="form-control" placeholder="Nama Lengkap" required >
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="nik">NIK <small class="text-danger">*</small></label>
                                                <input type="text" minlength="16" class="form-control" maxlength="16" pattern="{0-9}{0,16}" name="nik" id="nik" onkeypress='validate(event)' placeholder="NIK" title="Minimum 16 angka" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tanggal_lahir" id="setTodaysDate" class="form-control" required>
                                                <script>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @foreach($jenis_kelamin as $jk)
                                                    <option value="{{$jk->uuid}}">{{$jk->nama}}</option>
                                                @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group d-flex flex-column">
                                              ...
                                              <input type="text" title="Harus Diawali Angka 0 dan Minimum 9 angka" pattern="[0][0-9]{9,}" name="no_hp" id="handphone" class="form-control" onkeypress='validate(event)'
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="alamat" id="alamatlengkap" cols="30" rows="4" class="form-control" placeholder="Masukkan Alamat Lengkap" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="jenis_aduan" id="jenisaduan" class="form-select" required>
                                                    ...
                                                    @foreach ($jenis_aduan as $j)
                                                        <option value="{{$j->uuid}}">{{$j->nama}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <input type="file" id="fotokondisi" name="foto_kondisi" data-show-remove="false" class="dropify" />
                                            <div class="warn">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group file-area">
                                                ...
                                                <div style="position: relative">
                                                    <input type="file" name="surat_pengantar" accept="application/pdf" id="images2" multiple="multiple"/>
                                                    <div class="file-dummy">
                                                        ...
                                                        <div class="default">
                                                            ...
                                                            <p>Unggah Disini</p><p class="text-muted" id="alert-images2"></p></div>
                                                    </div>
                                                </div>
                                                <div class="warn">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" name="nama_rekomendasi" id="rekomendasi" class="form-control" placeholder="Masukkan Nama Perekomendasian">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group d-flex flex-column">
                                                <label for="telepom">Telepon <small class="text-danger">*</small></label>
                                                <input required type="text" pattern="[0][0-9]{9,}" onkeypress='validate(event)' title="Harus Diawali Angka 0 dan Minimum 9 angka" name="telp_rekomendasi" [ng2TelInputOptions]="{initialCountry: 'eg'}" id="telepon" class="form-control" placeholder="Masukkan Nomor Telepon">
                                            </div>
                                            {{-- <script>
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-center">
                                        <button class="btn btn-success mx-3">Tambah</button>
