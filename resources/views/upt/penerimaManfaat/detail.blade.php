                                    ...
                                    <div class="row">
                                        @if ($pendaftar->tindakan = 3)
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group file-area">
                                                    ...
                                                    <img src="{{Storage::disk('s3')->temporaryUrl($pendaftar->kondisiterakhir->photo, \Carbon\Carbon::now()->addMinutes(3600))}}" class="img-fluid" alt="">
                                                </div>
                                            </div>
                                            @endif
                                        @endif
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nomor_registrasi" id="nomorregistrasi" value="{{$pendaftar->nomor_registrasi ?? null}}" class="form-control" placeholder="Masukkan Nomor Registrasi" required {{($pendaftar->tindakan!=3) ? null : "disabled"}}>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="nama">Nama Lengkap <small class="text-danger">*</small></label>
                                                <input type="text" name="nama_lengkap" id="nama" value="{{$pendaftar->nama_lengkap ?? null}}" class="form-control" placeholder="Nama Lengkap" required {{($pendaftar->tindakan!=3) ? null : "disabled"}}>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="nik">NIK <small class="text-danger">*</small></label>
                                                <input type="text" minlength="16" class="form-control" maxlength="16" pattern="[0-9]{0,16}" value="{{(int)$pendaftar->nik ?? null}}" name="nik" id="nik" onkeypress='validate(event)' placeholder="NIK" required {{($pendaftar->tindakan!=3) ? null : "disabled"}}>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" value="{{date('Y-m-d', strtotime($pendaftar->tanggal_lahir ?? null))}}" name="tanggal_lahir" id="setTodaysDate" class="form-control" required {{($pendaftar->tindakan!=3) ? null : "disabled"}}>
                                                <script>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tanggal_masuk" @if($pendaftar->tanggal_masuk) value="{{date('Y-m-d', strtotime($pendaftar->tanggal_masuk))}}" @endif id="tanggalmasuk" class="form-control" required {{($pendaftar->tindakan!=3) ? null : "disabled"}}>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="tanggalkeluar">Tanggal Keluar <small class="text-danger">*</small></label>
                                                <input type="date" @if($pendaftar->tanggal_keluar) value="{{date('Y-m-d', strtotime($pendaftar->tanggal_keluar))}}" @endif name="tanggal_keluar" id="tanggalkeluar" class="form-control" required {{($pendaftar->tindakan!=3) ? null : "disabled"}}>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group file-area">
                                                ...
                                                <input type="file" id="foto_kondisi" name="foto_kondisi" data-show-remove="false" accept="image/*" class="dropify" data-default-file="" {{($pendaftar->tindakan!=3) ? null : "disabled"}}/>
                                                <div class="warn">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group file-area">
                                                ...
                                                <div style="position: relative">
                                                    <input type="file" name="surat_pengantar" id="surat_pengantar" value="" multiple="multiple" {{($pendaftar->tindakan!=3) ? null : "disabled"}}/>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required name="nama_rekomendasi" id="rekomendasi" class="form-control" value="{{$pendaftar->nama_rekomendasi ?? null}}" placeholder="Masukkan Nama Perekomendasian" {{($pendaftar->tindakan!=3) ? null : "disabled"}}>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group d-flex flex-column">
                                                <label for="telepon">Telepon <small class="text-danger">*</small></label>
                                                <input type="text" pattern="[0][0-9]\d{8,}" name="telp_rekomendasi" onkeypress='validate(event)' title="Harus Diawali Angka 0 dan Minimum 9 angka" value="{{$pendaftar->telp_rekomendasi ?? null}}" [ng2TelInputOptions]="{initialCountry: 'eg'}" id="telepon" class="form-control" placeholder="Masukkan Nomor Telepon" required {{($pendaftar->tindakan!=3) ? null : "disabled"}}>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
