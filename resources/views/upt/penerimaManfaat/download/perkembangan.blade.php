...
<body>
    ...
    <table class="table table-stripped">
        ...
        {{-- <tr>
            ...
            <tr>
                <td colspan=12 height="24" align="center" valign=bottom><b><font face="Arial" size=4 color="#000000">Data Perkembangan</font></b></td>
            </tr>
            <tr>
    ...
    <table class="table table-bordered dt-responsive table" style="width: 100%">
        <thead>
            <tr>
                <th>No</th>
                <th>Keterangan</th>
        ...
        <tbody>
            @foreach ($data as $id => $item)
                <tr>
                    ...
                    <td style="width: calc(30%)">{{$item['keterangan']}}</td>
                    <td style="width: calc(65%)"><img src="{{$item['dokumentasi']}}" alt=""></td>
                </tr>
            @endforeach
        </tbody>
    </table>
